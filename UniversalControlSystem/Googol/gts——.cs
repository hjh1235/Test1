...
namespace gts
{
    public class mc
    {
        ...
        {
            public const TPusle HOME_NEGATIVE_DIS = -4000000;
            public const TPusle HOME_POSITIVE_DIS = 4000000;
            public const TSpeed HOME_SPEED_HIGH = 15;//速度为/ms
            public const TSpeed HOME_SPEED_LOW = 3;
            public const TSpeed RATE_SPEED = 1000;//速度比率
        }
