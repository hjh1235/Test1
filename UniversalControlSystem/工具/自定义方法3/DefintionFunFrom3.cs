...
{
    public partial class DefintionFunFrom3 : Form
    {
        public DefintionFunFrom3()
        {
            InitializeComponent();
        }
        ...
        int Num = 0;
        DefintionFun3 _DefintionFun3 /*= new _OutPut_Puse()*/;
        ...
        {  
            ...
            _DefintionFun3 = (DefintionFun3)tools[Num];
            _StepControlName.Text= _DefintionFun3.FunName;
            if (_DefintionFun3.FlowChar_StepControlLoop == Num)
            {
                _DefintionFun3.FlowChar_StepControlLoop = Num;
                步骤跳转.Text = Num.ToString();
            }
            else
            {
                步骤跳转.Text = _DefintionFun3.FlowChar_StepControlLoop.ToString();
            }
            try
            {                
            }
        ...
        {
            _DefintionFun3.RunFun(_DefintionFun3);
        }
        ...
        private void _StepControlName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                List<ImageTool> tools;
                tools = LoadData._ImageToolRun[_FlowChar_StepControlStepName];
                _DefintionFun3 = (DefintionFun3)tools[Step];
                _DefintionFun3.FunName = _StepControlName.Text;
            }
            catch 
            {
            }          
