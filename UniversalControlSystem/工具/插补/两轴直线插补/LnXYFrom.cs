...
{
    public partial class LnXYFrom : Form
    {
        public LnXYFrom()
        {
            InitializeComponent();
        ...
        public void ShowMesage(string Name,string StepName, int num)
        {
            ...
            _LnXY = (LnXY)tools[Num];
            _轴1Name.Text= _LnXY._轴1Name;
            _轴2Name.Text = _LnXY._轴2Name;

            EndX.Text = _LnXY.EndX.ToString();
            EndY.Text = _LnXY.EndY.ToString();
            StartSpeed.Text = _LnXY.StartSpeed.ToString();
            EndSpeed.Text = _LnXY.EndSpeed.ToString();
            if (_LnXY.FlowChar_StepControlLoop == Num)
            {
                _LnXY.FlowChar_StepControlLoop = Num;
                步骤跳转.Text = Num.ToString();
            }
            else
            {
                步骤跳转.Text = _LnXY.FlowChar_StepControlLoop.ToString();
            }
            try
            {                
            }
        ...
        private void 坐标系维度_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _LnXY = (LnXY)tools[Step];
                _LnXY.Cor = int.Parse(坐标系维度.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void 卡号textBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _LnXY = (LnXY)tools[Step];
                _LnXY.CardNum = int.Parse(卡号textBox1.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void 速度获取_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _LnXY = (LnXY)tools[Step];
                _LnXY.StartSpeed = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_LnXY._轴1Name].Auto_Speed;
                _LnXY.EndSpeed = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_LnXY._轴1Name].Auto_Speed;
                StartSpeed.Text = _LnXY.StartSpeed.ToString();
                EndSpeed.Text = _LnXY.EndSpeed.ToString();
            }
            catch (Exception)
        ...
        private void EndX_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _LnXY = (LnXY)tools[Step];
                _LnXY.EndX =double.Parse( EndX.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void EndY_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _LnXY = (LnXY)tools[Step];
                _LnXY.EndY = double.Parse(EndY.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void 终点坐标获取_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EndX.Text = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_LnXY._轴1Name].AisxCurrentPosition.ToString();
                _LnXY.EndX = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_LnXY._轴1Name].AisxCurrentPosition;

                EndY.Text = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_LnXY._轴2Name].AisxCurrentPosition.ToString();
                _LnXY.EndY = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_LnXY._轴2Name].AisxCurrentPosition;
            }
            catch (Exception)
            {
            }
        ...
        private void StartSpeed_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _LnXY = (LnXY)tools[Step];
                _LnXY.StartSpeed = double.Parse(StartSpeed.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void EndSpeed_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _LnXY = (LnXY)tools[Step];
                _LnXY.EndSpeed = double.Parse(EndSpeed.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void 步骤跳转_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                LnXY.FlowChar_StepControlLoop = int.Parse(步骤跳转.Text);
            }
            catch (Exception)
            {
            }
