...
{
    public partial class DefintionFunFrom : Form
    {
        public DefintionFunFrom()
        {
            InitializeComponent();
        }
        ...
        int Num = 0;
        DefintionFun _DefintionFun /*= new _OutPut_Puse()*/;
        ...
        {  
            ...
            _DefintionFun = (DefintionFun)tools[Num];
            _StepControlName.Text= _DefintionFun.FunName;
            if (_DefintionFun.FlowChar_StepControlLoop == Num)
            {
                _DefintionFun.FlowChar_StepControlLoop = Num;
                步骤跳转.Text = Num.ToString();
            }
            else
            {
                步骤跳转.Text = _DefintionFun.FlowChar_StepControlLoop.ToString();
            }
            try
            {                
            }
        ...
        {
            _DefintionFun.RunFun(_DefintionFun);
        }
        ...
        private void 步骤跳转_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DefintionFun.FlowChar_StepControlLoop = int.Parse(步骤跳转.Text);
            }
            catch (Exception)
            {
            }
        ...
        private void _StepControlName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tools = LoadData._ImageToolRun[_FlowChar_StepControlStepName];
                DefintionFun = (DefintionFun)tools[Step];
                DefintionFun.FunName = _StepControlName.Text;
            }
            catch 
            {
            }          
