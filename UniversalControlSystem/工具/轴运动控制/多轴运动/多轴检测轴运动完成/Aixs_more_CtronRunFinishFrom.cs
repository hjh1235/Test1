...
{
    public partial class Aixs_more_CtronRunFinishFrom : Form
    {
        public Aixs_more_CtronRunFinishFrom()
        {
            InitializeComponent();
        }
        ...
        int Num = 0;
        Aixs_more_CtronRunFinish _Aixs_more_CtronRunFinish /*= new _OutPut_Puse()*/;
        ...
        {  
            ...
            _Aixs_more_CtronRunFinish = (Aixs_more_CtronRunFinish)tools[Num];
            for (int i = 0; i < _Aixs_more_CtronRunFinish.Data.Count; i++)
            {
                int idx = dgv_deviceList.Rows.Add();
                dgv_deviceList.Rows[idx].Tag = _Aixs_more_CtronRunFinish.Data[i].AixsName;
                ...
                dgv_deviceList.Rows[idx].Cells[0].Value = _Aixs_more_CtronRunFinish.Data[i].AixsName;
            }
            if (_Aixs_more_CtronRunFinish.FlowChar_StepControlLoop == Num)
            {
                _Aixs_more_CtronRunFinish.FlowChar_StepControlLoop = Num;
                步骤跳转.Text = Num.ToString();
            }
            else
            {
                步骤跳转.Text = _Aixs_more_CtronRunFinish.FlowChar_StepControlLoop.ToString();
            }

            //_StepControlName.Text= _Aixs_more_Ctron.AixsName;
            //位置textBox1.Text = _Aixs_more_Ctron.Pos.ToString() ;
            //速度textBox2.Text = _Aixs_more_Ctron.Speed.ToString();
            //加速度textBox3.Text = _Aixs_more_Ctron.Acc.ToString();
            //减速度textBox4.Text = _Aixs_more_Ctron.Dec.ToString();
            try
            {                
            }
            catch 
        ...
        {
            _Aixs_more_CtronRunFinish.CheckFinish(_Aixs_more_CtronRunFinish);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _Aixs_more_Ctron.Data[Line].Pos = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_Aixs_more_Ctron.Data[Line].AixsName].AisxCurrentPosition;
              //  位置textBox1.Text = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_Aixs_more_Ctron.Data[Line].AixsName].AisxCurrentPosition.ToString();
                //位置textBox1.Text = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_Aixs_more_Ctron.AixsName].AisxCurrentPosition.ToString();
                //_Aixs_more_Ctron.Pos = Hard_Ward_Contral.Aisx_Hard_Doc.mAisx_Hard_Date_Dictionary[_Aixs_more_Ctron.AixsName].AisxCurrentPosition;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (_AxisName.Text!="")
            {
                ...
                List<ImageTool> tools;
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _Aixs_more_CtronRunFinish = (Aixs_more_CtronRunFinish)tools[Step];

                Aixs_moreAixsData _Aixs_moreAixsData = new Aixs_moreAixsData();
                _Aixs_more_CtronRunFinish.Data.Add(_Aixs_moreAixsData);
                _Aixs_more_CtronRunFinish.Data[_Aixs_more_CtronRunFinish.Data.Count - 1].AixsName = _AxisName.Text;
                //if ()
                //{
                //}
                //_Aixs_more_Ctron._DataDic.Add(_AxisName.Text, _AixsData); 
            }
        ...
        private void dgv_deviceList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    List<ImageTool> tools;
            //    tools = LoadData._ImageToolRun[TOOLName.Text];
            //    //_Aixs_more_Ctron._DataDic = (Aixs_more_Ctron)tools[Step];
        ...
        {
            int Line = dgv_deviceList.CurrentRow.Index;
            _Aixs_more_CtronRunFinish.Data.RemoveAt(Line);
