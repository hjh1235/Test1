...
{
    public partial class OutPutFrom : Form
    {
        public OutPutFrom()
        {
            InitializeComponent();
        ...
        public void ShowMesage(string Name,string StepName, int num)
        {
            ...
            _OutPut_Puse = (OutPut)tools[Num];
            _StepControlName.Text= _OutPut_Puse.IO_Name;
            状态.Text = _OutPut_Puse.OutSta;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                OutPut _OutPut_Puse /*= new _OutPut_Puse()*/;
