...
{
    public partial class F_Delay_DeOutPutFrom : Form
    {
        public F_Delay_DeOutPutFrom()
        {
            InitializeComponent();
        }
        ...
        public void ShowMesage(string Name,string StepName, int num)
        {
            ...
            F_Delay_DeeOutPut _OutPut_Puse;
            List<ImageTool> tools;

            tools = LoadData._ImageToolRun[TOOLName.Text];
            _OutPut_Puse = (F_Delay_DeeOutPut)tools[Num];
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                F_Delay_DeeOutPut _OutPut_Puse /*= new _OutPut_Puse()*/;
                ...
                tools= LoadData._ImageToolRun[TOOLName.Text];
                _OutPut_Puse= (F_Delay_DeeOutPut)tools[Step];
        ...
        private void 次数_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                F_OutPut_DeeDelay _OutPut_Puse /*= new _OutPut_Puse()*/;
                ...
                tools = LoadData._ImageToolRun[TOOLName.Text];
                _OutPut_Puse = (F_OutPut_DeeDelay)tools[Step];
