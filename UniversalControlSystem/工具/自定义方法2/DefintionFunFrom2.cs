...
{
    public partial class DefintionFunFrom2 : Form
    {
        public DefintionFunFrom2()
        {
            InitializeComponent();
        }
        ...
        int Num = 0;
        DefintionFun2 _DefintionFun2 /*= new _OutPut_Puse()*/;
        ...
        {  
            ...
            _DefintionFun2 = (DefintionFun2)tools[Num];
            _StepControlName.Text= _DefintionFun2.FunName;
            if (_DefintionFun2.FlowChar_StepControlLoop == Num)
            {
                _DefintionFun2.FlowChar_StepControlLoop = Num;
                步骤跳转.Text = Num.ToString();
            }
            else
            {
                步骤跳转.Text = _DefintionFun2.FlowChar_StepControlLoop.ToString();
            }
            try
            {                
            }
        ...
        {
            _DefintionFun2.RunFun(_DefintionFun2);
        }
        ...
        private void _StepControlName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                List<ImageTool> tools;
                tools = LoadData._ImageToolRun[_FlowChar_StepControlStepName];
                _DefintionFun2 = (DefintionFun2)tools[Step];
                _DefintionFun2.FunName = _StepControlName.Text;
            }
            catch 
            {
            }          
