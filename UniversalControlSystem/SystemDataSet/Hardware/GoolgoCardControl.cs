...
{
    public class GoolgoCardControl
    {
        ...
        //{
        //    Program.logger.Info("---------------------------------");
        //    Program.logger.Info("开始XY圆弧插补运动");
        ...
        //public void BuildCor(short num, CoordinateType coordinateType)
        //{
        //    Global.logger.Info("---------------------------------");
        ...
        //public bool StartManualPulserOperation(int axis_ID)
        //{
        //    throw new NotImplementedException();
        //}
